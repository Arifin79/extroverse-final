...
class AdminAssignmentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view ('admin/assignment/index', ['assignment' => $assignment])->with('i', (request()->input('page', 1)-1) *5);
    }
    ...
    public function store(Request $request){
        ...
        $product->save();
        return redirect()->route('admin/assignment/index')->with('success', 'Assignment Added successfully');

    }

    public function edit($id){
        $assignment = Assignment::findOrFail($id);
        return view('admin/assignment/edit', ['assignment' => $assignment]);
    }
    ...
    public function update(Request $request, Assignment $assignment){
        ...
        return redirect()->route('admin/assignment/index')->with('success', 'Product Has Been Updated Successfully');
    ...
    public function destroy($id){
        ...
        $assignment->delete();
        return redirect('admin/assignment')->with('success', 'product Deleted!');
    }

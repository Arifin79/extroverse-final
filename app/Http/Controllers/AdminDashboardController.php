...
class AdminDashboardController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view ('admin/dashboard/index', ['assignment' => $assignment, 'information' => $information])->with('i', (request()->input('page', 1)-1) *5);
    }
    ...
    public function storeInfo(Request $request){
        ...
        $product->save();
        return redirect()->route('admin/dashboard/index')->with('success', 'Assignment Added successfully');
